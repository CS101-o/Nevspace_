    ...
    <div className="bg-blue-950 min-h-screen text-white">
      ...
      <section id="overview" className="relative h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-32">
          <h1 className="text-6xl font-bold mb-4">Bitirim</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border-t border-blue-800 pt-4">
              ...
              <div className="text-xl mt-2">NET FEBRUARY 2025</div>
            </div>
            <div className="border-t border-blue-800 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-blue-100 leading-relaxed">
                Bitirim is a represantaion of capabilities in hardware and aviation technologies
              </p>
            </div>
            <div>
            ...
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-blue-950 bg-opacity-0 group-hover:bg-opacity-50 transition-opacity duration-300 rounded-lg">
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white text-lg font-bold">Bitirim Board</span>
                </div>
              </div>
            </div>
