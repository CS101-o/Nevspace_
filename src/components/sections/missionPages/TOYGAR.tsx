    ...
    <div className="bg-blue-950 min-h-screen text-white">
      ...
      <section id="overview" className="relative h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-32">
          <h1 className="text-6xl font-bold mb-4">TOYGAR</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-blue-100 leading-relaxed">
                The Toygar mission represents a significant milestone in our space exploration program. 
                This mission aims to demonstrate advanced capabilities in engine power.
              </p>
            </div>
            <div>
      ...
      <section id="gallery" className="py-16 bg-blue-900 scroll-mt-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-blue-950 bg-opacity-0 group-hover:bg-opacity-50 transition-opacity duration-300 rounded-lg">
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white text-lg font-bold">Mission Preparation</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              <img 
                src="/images/Toygar6.png" 
                alt="Govde"
                className="w-full h-64 object-cover rounded-lg transition-transform duration-300 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-blue-950 bg-opacity-0 group-hover:bg-opacity-50 transition-opacity duration-300 rounded-lg">
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white text-lg font-bold">Cylinder Body</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              <img 
                src="/images/Toygar7.png" 
                alt="open cut cylinder"
                className="w-full h-64 object-cover rounded-lg transition-transform duration-300 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-blue-950 bg-opacity-0 group-hover:bg-opacity-50 transition-opacity duration-300 rounded-lg">
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white text-lg font-bold">Open-cut Cylinder Body</span>
                </div>
              </div>
            </div>
          </div>
